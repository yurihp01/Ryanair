...
class SearchViewController: UIViewController {
    ...
    private lazy var teenField: UITextField = {
        ...
        teenField.placeholder = "Teenagers"
    ...
    private lazy var childField: UITextField = {
        ...
        childField.placeholder = "Children"
    ...
    private lazy var button: UIButton = {
        ...
        button.addTarget(self, action: #selector(openSearchResults), for: .touchUpInside)
        return button
    }()
    
    private lazy var stackView: UIStackView = {
        let stackView = UIStackView(arrangedSubviews: [originField, destinationField, dateField, adultField, teenField, childField, jsonDataSwitch, button])
...
private extension SearchViewController {
    ...
    func setConstraints() {
        NSLayoutConstraint.activate([
            ...
            button.bottomAnchor.constraint(equalTo: stackView.bottomAnchor, constant: -24)
        ])
